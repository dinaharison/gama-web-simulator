...
experiment maths type: gui {
	...
	reflex result {
		write(to_json(["prey"::first(LotkaVolterra_agent).nb_prey,
					   "predator"::first(LotkaVolterra_agent).nb_predator,
					   "ratioPredator"::predator_death_rate / predation_efficiency,
					   "ratioPrey"::prey_birth_rate/predation_rate,
					   "cycle"::cycle
					   ]
					   , true));
	}
